class IndexedMinDHeap:
    ...
    def _heapify_down(self, index):
        ...
        for i in range(self.d):
            ...
            if child_index < len(self.heap) and self.heap[child_index][0] < self.heap[smallest][0]:
...
# Example usage
heap = IndexedMinDHeap(d=3)  # Ternary heap
...
print("Value at index 3:", heap.get(3))  # Should be 50 or adjusted value
