class DAryMaxHeap:
    ...
    def heapify_down(self, index):
        ...
        for i in range(self.d):
            ...
            if child_index < size and self.heap[child_index] > self.heap[largest]:
                largest = child_index
        if largest != index:
...
if __name__ == "__main__":
    d_ary_heap = DAryMaxHeap(3)  # A ternary heap (D=3)
    ...
    print("Max:", d_ary_heap.peek())  # Output: Max: 20

    print("Extract Max:", d_ary_heap.extract_max())  # Output: Extract Max: 20
